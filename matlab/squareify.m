...
for groupi = { 'control-salento', 'control-uc' }
    group = cell2mat(groupi);
    folder = fullfile( '/home/acruz/Xyllella-Fastidiosa-Dataset/raw/vitus-vinifera/', group );
    saveFolder = fullfile( '/home/acruz/Xyllella-Fastidiosa-Dataset/segmented/vitus-vinifera/', group );
